...
const Logo = (props: LogoProps) => {
	return (
		<svg
			...
			x="0px"
			y="0px"
			// viewBox={props.includeType ? '0 0 595.3 116.3' : '0 0 116.5 116.3'}
			viewBox={`0 0 ${props.includeType ? 595.3 : 116.3} 116.3`}
			xmlSpace="preserve"
			style={{
				width: props.width,
				height: props.height,
		...
		>
			...
			<path
				style={{ fill: 'var(--clr-accent-secondary)' }}
          ...
          C1,33,3.6,45,7.9,56.2c6.1-9.6,13.4-18.4,22.3-26C47.8,15.1,71.5,4.7,103.7,0.1L10.9,0z"
			/>
			<path
				style={{ fill: 'var(--clr-accent-primary)' }}
